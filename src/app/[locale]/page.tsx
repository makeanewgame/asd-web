  ...
  const cardMock = [
    {
      ...
      description: (
        <TDiv>
          {
            '"Kanyona hâkim konumu ve modern mimarisiyle Mirador, doğayla iç içe ayrıcalıklı bir yaşam sunuyor. Keşfetmeye Değer Bir Yaşam...":"With its commanding location overlooking the canyon and modern architecture, Mirador offers a privileged life intertwined with nature. A Life Worth Exploring..."'
          }
        </TDiv>
      ),
      id: 3,
    ...
    },
    {
      ...
      description: (
        <TDiv>
          {
            '"Safranbolu’nun en prestijli noktasında, estetik ve konforu bir araya getiren özel bir yaşam alanı. Şimdi keşfedin.":"A special living space combining aesthetics and comfort in the most prestigious location of Safranbolu. Discover it now."'
          }
        </TDiv>
      ),
      id: 3,
    ...
    {
      title: (
        <TDiv>{'"Dadibra Villas Safranbolu":"Dadibra Villas Safranbolu"'}</TDiv>
      ),
      description: (
        <TDiv>
          {
            '"Safranbolu’nun en özel noktasında, ihtişam ve konforu doğayla buluşturan seçkin bir yaşam sizi bekliyor.Hayalinizdeki yaşamı şimdi keşfedin.":"An exclusive lifestyle that combines splendor and comfort with nature awaits you in Safranbolus most exclusive location. Discover your dream life now."'
          }
        </TDiv>
      ),
      id: 2,
  ...
  const workflowMock = [
    ...
    },
    {
      ...
      description: (
        <TDiv>
          {
            '"İhtiyaçların belirlenmesinin ardından, müşterilerimize özel olarak hazırlanan teklif sunulur. Teklifin kabul edilmesi durumunda, taraflar arasında resmi bir sözleşme imzalanır.":"Following the identification of needs, a proposal tailored specifically for our clients is presented. Upon acceptance of the proposal, a formal contract is signed between the parties."'
          }
        </TDiv>
      ),
    },
    {
      ...
      description: (
        <TDiv>
          {
            '"Sözleşmenin imzalanmasının ardından, projenin planlanması ve yönetimi için uzman ekibimiz devreye girer. Proje süreci boyunca düzenli olarak ilerleme raporları hazırlanır ve müşterilerimizle paylaşılır.":"After the contract is signed, our expert team takes over for the planning and management of the project. Regular progress reports are prepared throughout the project process and shared with our clients."'
          }
        </TDiv>
      ),
    },
    {
      ...
      description: (
        <TDiv>
          {
            '"Proje tamamlandığında, ürün ya da hizmet müşteriye teslim edilir. Teslimat sonrası destek hizmetleri de sunularak, müşterilerimizin memnuniyeti sağlanır.":"When the project is completed, the product or service is delivered to the customer. Post-delivery support services are also provided to ensure customer satisfaction."'
          }
        </TDiv>
      ),
    },
  ...
  return (
    <>
      <div className="h-screen w-full">
        ...
        <SocialMediaBar />
        <div
          className="h-[800px] w-full bottom-0 absolute z-10"
          style={{
            background:
              "linear-gradient(180deg, rgba(24, 66, 143, 0%), #071329 100%)",
          }}
        ></div>

        <div
          className="flex container gap-4 relative z-20 mx-auto -mt-[300px] md:-mt-[550px] text-white px-4"
          style={{
            height: "auto",
          }}
        >
          <div className="flex flex-col md:basis-3/5 gap-2 md:gap-4">
            <div className="text-base md:text-[20px] text-[#ADD2FF]">
              <TDiv>{'"ASD GRUP":"ASD GROUP"'}</TDiv>
            </div>
            <div className="text-3xl md:text-[66px] font-bold leading-tight md:leading-18 whitespace-pre-line">
              <TDiv>
                {'"YARINLAR İÇİN\nİNŞA EDİYORUZ":"WE BUILD FOR TOMORROW"'}
              </TDiv>
            </div>
            <div className="text-lg md:text-[28px] leading-relaxed">
              <TDiv>
                {
                  '"30 yılı aşkın tecrübeyi, ileri cephe teknolojileri ve kusursuz proje yönetim anlayışını birleştirerek, mimari vizyonunuzu estetik, dayanıklı ve enerji verimli yapılara dönüştürür.":"By combining over 30 years of experience, advanced façade technologies and flawless project management approach, it transforms your architectural vision into aesthetic, durable and energy-efficient structures."'
                }
              </TDiv>
            </div>
            <div className="w-fit">
              <Link href="/contact" className="mb-8 md:mb-0">
                <GlassButton>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M9 15H19.844L15.737 10.146L17.263 8.854L23.31 16L17.263 23.146L15.737 21.854L19.844 17H9V15Z"
                      fill="#08132A"
                    />
                  </svg>
                </GlassButton>
      ...
      <div className="container px-4 py-8 md:py-16">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-0">
          <h2 className="text-4xl md:text-[68px] font-bold">
            <TDiv>"Projelerimiz":"Our Projects"</TDiv>
          </h2>
          <GlassButton>
      ...
      <div className="relative min-h-screen flex items-center py-16 md:py-0">
        <div className="absolute w-full h-full md:h-[1200px] bottom-0 left-0 right-0">
          <Image
            ...
            alt="aboutus_bg"
            fill
            className="mt-8 object-cover mix-blend-overlay absolute"
          />
        </div>
        <div className="container flex flex-col relative px-4">
          <div className="flex flex-col md:flex-row justify-between text-xs md:text-sm mt-8 gap-2 md:gap-0">
            <div>
              <TDiv>"30+ Yıllık Deneyim":"30+ Years of Experience"</TDiv>
            </div>
            <div>
              <TDiv>
                "Hayatın Kendisinden İlham Alıyoruz":"We Draw Inspiration from
                Life Itself"
              </TDiv>
            </div>
          </div>
          <h2 className="text-4xl md:text-[68px] font-bold my-4 md:my-8">
            <TDiv>"Hakkımızda":"About Us"</TDiv>
          </h2>
          <div className="text-lg md:text-[40px] leading-6 md:leading-10 font-light mb-6 md:mb-8">
            <TDiv>
              ""tecrübe ve bilginin birbirini tamamladığı bir ortamda,
              yeniliklere açık bir yaklaşım benimsemektedir. Teknolojiyi sürekli
              takip eden düşünce yapımız ve alanında uzmanlaşmış seçkin
              kadromuzla, her geçen gün yeni tasarımlar üzerinde çalışarak
              sektördeki gelişmelere öncülük ediyoruz."":""In an environment
              where experience and knowledge complement each other, we adopt an
              approach open to innovation. With our mindset that constantly
              follows technological advancements and our distinguished team of
              experts in their fields, we are pioneering developments in the
              sector by working on new designs every day.""
            </TDiv>
          </div>

          <div className="flex gap-2 flex-wrap md:flex-nowrap">
            <Image
              src="/cert001-asd.webp"
              alt="cert001-asd"
              width={256}
              height={326}
              className="w-24 h-auto md:w-64"
            />
            <Image
              src="/cert002-asd.webp"
              alt="cert002-asd"
              width={256}
              height={326}
              className="w-24 h-auto md:w-64"
          ...
          <div className="md:absolute md:right-0 md:top-100 md:mt-16 mt-8">
            <LiquiedGlassCard
              className="flex flex-col relative w-full md:w-fit p-2 md:p-4"
              contentClassName="px-4 md:px-6 py-4 z-0"
              radius="14px"
            >
              <AboutUsComp />
            </LiquiedGlassCard>
      ...
      <div className="container py-8 md:py-16 px-4">
        <h2 className="text-4xl md:text-[68px] font-bold my-4 md:my-8">
          <TDiv>"Rakamlarla Biz":"Us by the Numbers"</TDiv>
        </h2>
        <div>
          <NumbersComp />
        </div>
      ...
      <div className="bg-[#F3F9FF]">
        <div className="container py-8 md:py-16 px-4">
          <h2 className="text-4xl md:text-[68px] font-bold my-4 md:my-8 text-[#08132A]">
            <TDiv>"İş Akışımız":"Our Workflow"</TDiv>
          </h2>
          <div className="text-lg md:text-[28px] text-[#08132A] mb-6 md:mb-8 leading-6 md:leading-10 font-light">
            <TDiv>
              ""her projeye özel çözümler üretirken standartlarımızdan ödün
              vermeden sistematik bir iş akışı izliyoruz. Tüm süreçlerimizde
              müşteri memnuniyetini merkeze alıyor, esnek ve hızlı çözümler
              sunarak katma değer yaratıyoruz."":""
            </TDiv>
          </div>
