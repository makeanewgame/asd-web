          ...
          <div className="overflow-x-auto -mx-4 px-4 scrollbar-hide">
            <Tabs
              ...
              classNames={{
                ...
                tabContent:
                  "group-data-[selected=true]:text-[#ADD2FF] text-default-500 font-medium",
              }}
            >
...
function ProjectBanner({ selectedType }: { selectedType: string }) {
  ...
  return (
    <div className="relative lg:h-[449px] h-80 overflow-hidden lg:-mt-[100px]">
      {/* Background Image */}
      <div
        className="absolute inset-0 lg:bg-right bg-no-repeat lg:bg-contain bg-cover bg-center"
        style={{
      ...
      {/* Content */}
      <div className="relative z-10 container lg:mx-auto lg:px-4 h-full flex items-center text-white">
        <div className="text-white lg:max-w-2xl">
          <h2 className="text-5xl font-bold mb-4">{banner.title}</h2>
          <p className="text-xl text-white/90">{banner.headline}</p>
          <p className="text lg:text-[#849DBC] text-white text-balance">
            {banner.description}
          </p>
        </div>
      </div>
