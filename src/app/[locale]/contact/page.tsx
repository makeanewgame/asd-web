      ...
      <div className="relative min-h-[1600px] overflow-hidden">
        ...
        <div className="container pt-[480px]">
          <div className="flex flex-col">
            ...
            <div className="flex lg:flex-row flex-col pt-24">
              {/* Left: Intro text */}
              <div className="flex flex-col basis-1/2">
                <p className="text-xl md:text-3xl leading-snug text-white/95">
                  Bizimle İletişime Geçin – Her Proje, <br /> Yeni Bir Hikâyenin
                  Başlangıcıdır
                </p>
                <p className="mt-10 max-w-2xl text-lg text-white/90">
                  Her projenin ardında bir hayal, bir ihtiyaç ve bir vizyon
                  olduğuna inanıyoruz. İster konut, ister taahhüt projeleri…
                  Mimarların hayalini mühendisliğin gücüyle buluştururken, her
                  zaman en yüksek kalite standartlarını gözetiyoruz.
                </p>
              </div>

              {/* Right: Form card */}
              <div className="flex lg:justify-center lg:basis-1/2">
                <LiquiedGlassCard
                  className="relative p-8 lg:w-[75%] w-full mt-6"
        ...
        <section className="relative mx-auto max-w-6xl px-6 pb-24 ">
          ...
          <div className="mt-10 text-center text-white/90">
            <p>
              Çalışma Saatleri:
              <br /> Pazartesi – Cuma: 09:00 – 18:00 &nbsp;•&nbsp; Cumartesi:
              09:00 – 13:00 &nbsp;•&nbsp; Pazar: Kapalı
            </p>
          </div>
        </section>
      </div>
