...
export default function SocialMediaBar() {
  ...
  const linkedin =
    "https://tr.linkedin.com/company/asd-cephe-sistemleri-ve-i%CC%87n%C5%9Faat";
  ...
  return (
    <div className="h-screen flex lg:flex-col flex-row justify-center items-center lg:w-[22px] gap-2 absolute left-0 top-0 lg:p-8 p-4 z-20">
      {miniBtn({
        href: facebook,
        children: (
          <svg
